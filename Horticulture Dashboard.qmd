...
.panel-tabset .panel-tabset .tab-pane {
overflow: hidden !important;
height: auto !important;
}
...
.panel-tabset .panel-tabset .tab-content::-webkit-scrollbat {
display: none !important;
}

.panel-tabset .panel-tabset .card-header .card-toggle,
.panel-tabset .panel-tabset .card-header .card-tools {
display: none !important;
}

.panel-tabset .panel-tabset .card-header{
cursor: default !important;
}

.panel-tabset .panel-tabset .card-body{
...
```{r}
bslib::value_box(
  title = HTML("<span style='font-size:1rem'>Consumer Food Price Increase (2023-2024) - Ireland:</span>"),
  value = "6.5%",
...
```{r}
bslib::value_box(
  title = HTML("<span style='font-size:1rem'>Consumer Food Price Increase (2023-2024) - EU27:</span>"),
  value = "6.2%",
  theme =  value_box_theme(
    bg = "#8fb6df",
    fg = "white"
...
```{r}
bslib::value_box(
  title = HTML("<span style='font-size:1rem'>Consumer Food Price Increase (2023-2024)- World:</span>"),
  value = "-3.3%",
  theme =  value_box_theme(
    bg = "#3c5268",
    fg = "white"
...
bslib::value_box(
  ...
  value = "",
  subtitle = HTML("<span style='font-size:0.85rem'>Input Cost Growth vs Producer Price Growth (2020-2023)</span>"),
  theme =  value_box_theme(
    bg = "#3c5268",
    fg = "white"
  ),
